 ...
 */
import { VerbsInfo, AdjectivesInfo, WordsInfo } from 'rosaenlg-pug-code-gen/dist/LanguageCodeGen';
...
export declare class CodeGenHelper {
    ...
    getWordCandidateFromVerbalForm(args: string): string[];
    ...
    getAdjCandidateFromSubjectVerbAdj(args: string): string[];
    ...
    getStringFromArg(arg: any): string;
