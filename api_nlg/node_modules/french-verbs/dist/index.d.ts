...
export declare type FrenchAux = 'AVOIR' | 'ETRE';
export declare type GendersMF = 'M' | 'F';
export declare type Numbers = 'S' | 'P';
export declare function getConjugation(verbsList: VerbsInfo, verb: string, tense: string, person: number, aux: FrenchAux, agreeGender: GendersMF, agreeNumber: Numbers, pronominal: boolean): string;
