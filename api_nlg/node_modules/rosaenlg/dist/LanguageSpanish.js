...
const spanish_words_2 = require("spanish-words");
...
class LanguageSpanish extends LanguageImpl_1.LanguageImpl {
    ...
    getSubstantive(subst, number) {
        if (number === 'S') {
            ...
            return spanish_words_2.getPluralSpanishWord(this.getDictManager().getWordData(), subst);
        }
    }
    getConjugation(_subject, verb, tense, number, _conjParams, _genderNumberManager, embeddedVerbs) {
        ...
        return spanish_verbs_wrapper_1.getConjugation(embeddedVerbs, verb, tense, number);
    }
    isPlural(val) {
