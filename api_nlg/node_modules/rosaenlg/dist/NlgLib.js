...
function getRosaeNlgVersion() {
    return '2.1.7'; // will be replaced by gulp when copied into dist/
}
...
class NlgLib {
    constructor(params) {
        ...
        this.helper = new Helper_1.Helper(this.genderNumberManager, params.renderDebug);
        ...
        this.verbsManager = new VerbsManager_1.VerbsManager(this.languageImpl, this.genderNumberManager, this.synManager);
        ...
        this.asmManager = new AsmManager_1.AsmManager(this.saveRollbackManager, this.randomManager, this.helper);
        ...
        this.adjectiveManager = new AdjectiveManager_1.AdjectiveManager(this.languageImpl, this.genderNumberManager, this.synManager);
        ...
        this.valueManager = new ValueManager_1.ValueManager(this.languageImpl, this.refsManager, this.genderNumberManager, this.randomManager, this.adjectiveManager, this.helper, this.possessiveManager, this.asmManager, this.synManager, this.languageImpl.languageCommon.constants);
        this.sentenceManager = new SentenceManager_1.SentenceManager(this.languageImpl, this.verbsManager, this.valueManager, this.adjectiveManager, this.synManager);
    ...
    filterAll(unfiltered) {
        return rosaenlg_filter_1.filter(unfiltered, this.languageImpl.getLanguageCommon(), { renderDebug: this.renderDebug });
    }
    getSaidManager() {
