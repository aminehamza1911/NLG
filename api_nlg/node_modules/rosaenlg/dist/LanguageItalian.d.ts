...
export declare class LanguageItalian extends LanguageImpl {
    ...
    getConjugation(_subject: any, verb: string, tense: string, number: Numbers, conjParams: ConjParamsIt, genderNumberManager: GenderNumberManager, embeddedVerbs: VerbsData): string;
