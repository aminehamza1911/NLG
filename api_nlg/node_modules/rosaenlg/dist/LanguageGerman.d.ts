...
export declare class LanguageGerman extends LanguageImpl {
    ...
    getConjugation(_subject: any, verb: string, tense: string, number: Numbers, conjParams: ConjParamsDe, _genderNumberManager: GenderNumberManager, embeddedVerbs: VerbsData, verbParts: VerbParts): string;
